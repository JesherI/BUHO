...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed left-12 top-[72px] h-[calc(100vh-72px)] bg-black border-r border-amber-500/20 z-30 overflow-hidden shadow-2xl transition-all duration-300 ease-in-out ${
        isOpen ? 'w-80 opacity-100 visible' : 'w-0 opacity-0 invisible'
      }`}>
        <div className="flex items-center justify-between p-4 border-b border-amber-500/20 bg-black min-w-[320px]">
        ...
        <div className="h-full overflow-y-auto pb-20 scrollbar-thin scrollbar-thumb-amber-500/20 scrollbar-track-transparent min-w-[320px]">
          {activeTab === 'chats' && (
            <div className="p-4">
